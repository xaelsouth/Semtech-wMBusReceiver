...
/*
 * Setup for STMicroelectronics STM32 Nucleo64-L476RG with SX1272 board.
 */

/*
 * Board identifier.
 */
#define BOARD_ST_NUCLEO64_L476RG_SX1272
#define BOARD_NAME                  "STMicroelectronics STM32 Nucleo64-L476RG with SX1272"
...
#define GPIOA_SX1276_DIO2           8U
#define GPIOA_ARD_D8                9U
#define GPIOA_SX1276_DIO5           9U
#define GPIOA_ARD_D2                10U
#define GPIOA_SX1272_DIO0           10U
#define GPIOA_SX1276_DIO0           10U
...
#define GPIOB_SWO                   3U
#define GPIOB_SX1272_DIO1           3U
#define GPIOB_ARD_D5                4U
#define GPIOB_SX1272_DIO3           4U
#define GPIOB_ARD_D4                5U
#define GPIOB_SX1272_DIO2           5U
#define GPIOB_ARD_D10               6U
#define GPIOB_SPI1_NSS              6U
#define GPIOB_PIN7                  7U
#define GPIOB_ARD_D15               8U
#define GPIOB_ARD_D14               9U
#define GPIOB_ARD_D6                10U
#define GPIOB_SX1276_DIO1           10U
...
#define GPIOC_DBG_IRQ_FUNCTION2     5U
#define GPIOC_DBG_IRQ_FUNCTION1     6U
#define GPIOC_ARD_D9                7U
#define GPIOC_SX1276_RESET          7U
#define GPIOC_SDMMC1_D0_SDO         8U
#define GPIOC_DBG_IRQ_TRIGGERED     9U
#define GPIOC_PIN10                 10U
#define GPIOC_PIN11                 11U
#define GPIOC_SDMMC1_CK_SCK         12U
...
#define GPIOD_SDMMC1_CMD_SDI        2U
...
#define LINE_SX1272_RESET           PAL_LINE(GPIOA, 0U)
...
#define LINE_SX1276_DIO2            PAL_LINE(GPIOA, 8U)
#define LINE_ARD_D8                 PAL_LINE(GPIOA, 9U)
#define LINE_SX1276_DIO5            PAL_LINE(GPIOA, 9U)
#define LINE_ARD_D2                 PAL_LINE(GPIOA, 10U)
#define LINE_SX1272_DIO0            PAL_LINE(GPIOA, 10U)
#define LINE_SX1276_DIO0            PAL_LINE(GPIOA, 10U)
...
#define LINE_SX1272_DIO1            PAL_LINE(GPIOB, 3U)
#define LINE_ARD_D5                 PAL_LINE(GPIOB, 4U)
#define LINE_SX1272_DIO3            PAL_LINE(GPIOB, 4U)
#define LINE_ARD_D4                 PAL_LINE(GPIOB, 5U)
#define LINE_SX1272_DIO2            PAL_LINE(GPIOB, 5U)
#define LINE_ARD_D10                PAL_LINE(GPIOB, 6U)
#define LINE_SPI1_NSS               PAL_LINE(GPIOB, 6U)
#define LINE_ARD_D15                PAL_LINE(GPIOB, 8U)
#define LINE_ARD_D14                PAL_LINE(GPIOB, 9U)
#define LINE_ARD_D6                 PAL_LINE(GPIOB, 10U)
#define LINE_SX1276_DIO1            PAL_LINE(GPIOB, 10U)
...
#define LINE_DBG_IRQ_FUNCTION2      PAL_LINE(GPIOC, 5U)
#define LINE_DBG_IRQ_FUNCTION1      PAL_LINE(GPIOC, 6U)
#define LINE_ARD_D9                 PAL_LINE(GPIOC, 7U)
#define LINE_SX1276_RESET           PAL_LINE(GPIOC, 7U)
#define LINE_SDMMC1_D0_SDO          PAL_LINE(GPIOC, 8U)
#define LINE_DBG_IRQ_TRIGGERED      PAL_LINE(GPIOC, 9U)
#define LINE_SDMMC1_CK_SCK          PAL_LINE(GPIOC, 12U)
#define LINE_BUTTON                 PAL_LINE(GPIOC, 13U)
#define LINE_OSC32_IN               PAL_LINE(GPIOC, 14U)
#define LINE_OSC32_OUT              PAL_LINE(GPIOC, 15U)
#define LINE_SDMMC1_CMD_SDI         PAL_LINE(GPIOD, 2U)
 ...
 * GPIOA setup:
 *
 * PA0  - ARD_A0 ACD12_IN5 SX1272_RESET(output pushpull maximum).
 ...
 * PA8  - ARD_D7 SX1276_DIO2        (input pulldown).
 * PA9  - ARD_D8 SX1276_DIO5        (input pulldown).
 * PA10 - ARD_D2 SX1272_DIO0 SX1276_DIO0(input pulldown).
 * PA11 - PIN11                     (analog).
 * PA12 - PIN12                     (analog).
 ...
 * PA15 - PIN15                     (analog).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(GPIOA_ARD_A0) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOA_ARD_A0) |     \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOA_ARD_D8) |     \
                                     PIN_PUPDR_PULLDOWN(GPIOA_ARD_D2) |     \
 ...
 * PB1  - PIN1                      (analog).
 * PB2  - PIN2                      (analog).
 * PB3  - ARD_D3 SWO SX1272_DIO1    (input pulldown).
 * PB4  - ARD_D5 SX1272_DIO3        (input pulldown).
 * PB5  - ARD_D4 SX1272_DIO2        (input pulldown).
 * PB6  - ARD_D10 SPI1_NSS          (output pushpull maximum).
 * PB7  - PIN7                      (analog).
 * PB8  - ARD_D15                   (analog).
 * PB9  - ARD_D14                   (analog).
 * PB10 - ARD_D6 SX1276_DIO1        (input pulldown).
 * PB11 - PIN11                     (analog).
 * PB12 - PIN12                     (analog).
 * PB13 - PIN13                     (analog).
 * PB14 - PIN14                     (analog).
 ...
 * PC3  - PIN3                      (analog).
 * PC4  - PIN4                      (analog).
 * PC5  - DBG_IRQ_FUNCTION2         (output pushpull maximum).
 * PC6  - DBG_IRQ_FUNCTION1         (output pushpull maximum).
 * PC7  - ARD_D9 SX1276_RESET       (output pushpull maximum).
 * PC8  - SDMMC1_D0_SDO             (alternate 12).
 * PC9  - DBG_IRQ_TRIGGERED         (output pushpull maximum).
 * PC10 - PIN10                     (analog).
 * PC11 - PIN11                     (analog).
 * PC12 - SDMMC1_CK_SCK             (alternate 12).
...
#define VAL_GPIOC_MODER             (PIN_MODE_ANALOG(GPIOC_ARD_A5) |        \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_MODE_OUTPUT(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_MODE_OUTPUT(GPIOC_ARD_D9) |        \
                                     PIN_MODE_ALTERNATE(GPIOC_SDMMC1_D0_SDO) |\
                                     PIN_MODE_OUTPUT(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_MODE_ANALOG(GPIOC_PIN10) |         \
                                     PIN_MODE_ANALOG(GPIOC_PIN11) |         \
                                     PIN_MODE_ALTERNATE(GPIOC_SDMMC1_CK_SCK) |\
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_ARD_A5) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_ARD_D9) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_SDMMC1_D0_SDO) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN10) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN11) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOC_SDMMC1_CK_SCK) |\
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_ARD_A5) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_OSPEED_HIGH(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_OSPEED_HIGH(GPIOC_ARD_D9) |        \
                                     PIN_OSPEED_HIGH(GPIOC_SDMMC1_D0_SDO) | \
                                     PIN_OSPEED_HIGH(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_OSPEED_HIGH(GPIOC_PIN10) |         \
                                     PIN_OSPEED_HIGH(GPIOC_PIN11) |         \
                                     PIN_OSPEED_HIGH(GPIOC_SDMMC1_CK_SCK) | \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_ARD_A5) |     \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_PUPDR_FLOATING(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_PUPDR_PULLUP(GPIOC_ARD_D9) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_SDMMC1_D0_SDO) |\
                                     PIN_PUPDR_FLOATING(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_PUPDR_FLOATING(GPIOC_PIN10) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_PIN11) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_SDMMC1_CK_SCK) |\
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_ARD_A5) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOC_DBG_IRQ_FUNCTION2) | \
                                     PIN_ODR_LOW(GPIOC_DBG_IRQ_FUNCTION1) | \
                                     PIN_ODR_LOW(GPIOC_ARD_D9) |            \
                                     PIN_ODR_HIGH(GPIOC_SDMMC1_D0_SDO) |    \
                                     PIN_ODR_LOW(GPIOC_DBG_IRQ_TRIGGERED) | \
                                     PIN_ODR_HIGH(GPIOC_PIN10) |            \
                                     PIN_ODR_HIGH(GPIOC_PIN11) |            \
                                     PIN_ODR_HIGH(GPIOC_SDMMC1_CK_SCK) |    \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_ARD_A5, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOC_DBG_IRQ_FUNCTION2, 0U) |\
                                     PIN_AFIO_AF(GPIOC_DBG_IRQ_FUNCTION1, 0U) |\
                                     PIN_AFIO_AF(GPIOC_ARD_D9, 0U))
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_SDMMC1_D0_SDO, 12U) |\
                                     PIN_AFIO_AF(GPIOC_DBG_IRQ_TRIGGERED, 0U) |\
                                     PIN_AFIO_AF(GPIOC_PIN10, 0U) |         \
                                     PIN_AFIO_AF(GPIOC_PIN11, 0U) |         \
                                     PIN_AFIO_AF(GPIOC_SDMMC1_CK_SCK, 12U) |\
...
#define VAL_GPIOC_ASCR              (PIN_ASCR_DISABLED(GPIOC_ARD_A5) |      \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_ASCR_DISABLED(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_ASCR_DISABLED(GPIOC_ARD_D9) |      \
                                     PIN_ASCR_DISABLED(GPIOC_SDMMC1_D0_SDO) |\
                                     PIN_ASCR_DISABLED(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_ASCR_DISABLED(GPIOC_PIN10) |       \
                                     PIN_ASCR_DISABLED(GPIOC_PIN11) |       \
                                     PIN_ASCR_DISABLED(GPIOC_SDMMC1_CK_SCK) |\
...
#define VAL_GPIOC_LOCKR             (PIN_LOCKR_DISABLED(GPIOC_ARD_A5) |     \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOC_DBG_IRQ_FUNCTION2) |\
                                     PIN_LOCKR_DISABLED(GPIOC_DBG_IRQ_FUNCTION1) |\
                                     PIN_LOCKR_DISABLED(GPIOC_ARD_D9) |     \
                                     PIN_LOCKR_DISABLED(GPIOC_SDMMC1_D0_SDO) |\
                                     PIN_LOCKR_DISABLED(GPIOC_DBG_IRQ_TRIGGERED) |\
                                     PIN_LOCKR_DISABLED(GPIOC_PIN10) |      \
                                     PIN_LOCKR_DISABLED(GPIOC_PIN11) |      \
                                     PIN_LOCKR_DISABLED(GPIOC_SDMMC1_CK_SCK) |\
 ...
 * PD0  - PIN0                      (analog).
 * PD1  - PIN1                      (analog).
 * PD2  - SDMMC1_CMD_SDI            (alternate 12).
 * PD3  - PIN3                      (analog).
 * PD4  - PIN4                      (analog).
 * PD5  - PIN5                      (analog).
 * PD6  - PIN6                      (analog).
...
#define VAL_GPIOD_MODER             (PIN_MODE_ANALOG(GPIOD_PIN0) |          \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOD_SDMMC1_CMD_SDI) |\
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_SDMMC1_CMD_SDI) |\
...
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_HIGH(GPIOD_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOD_SDMMC1_CMD_SDI) |\
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_FLOATING(GPIOD_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOD_SDMMC1_CMD_SDI) |\
...
#define VAL_GPIOD_ODR               (PIN_ODR_HIGH(GPIOD_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOD_SDMMC1_CMD_SDI) |   \
...
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF(GPIOD_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOD_SDMMC1_CMD_SDI, 12U) |\
...
#define VAL_GPIOD_ASCR              (PIN_ASCR_DISABLED(GPIOD_PIN0) |        \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOD_SDMMC1_CMD_SDI) |\
...
#define VAL_GPIOD_LOCKR             (PIN_LOCKR_DISABLED(GPIOD_PIN0) |       \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOD_SDMMC1_CMD_SDI) |\
